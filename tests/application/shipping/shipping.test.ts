...
function makeStore(origin = true): Store {
  return Store.from({
    ...
    originRt: origin ? "01" : null,
    originRw: origin ? "02" : null,
    originKelurahan: origin ? "Sukamaju" : null,
    originKecamatan: origin ? "Sako" : null,
    originCity: origin ? "Palembang" : null,
    originProvince: origin ? "Sumatera Selatan" : null,
